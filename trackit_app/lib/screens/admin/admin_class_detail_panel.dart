...
class _Pagination extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // Cap the number of page buttons shown at once so this doesn't overflow
    // on a class with many pages -- a window of 5 centered on the current
          ...
          child: Container(
            ...
            child: icon != null
                ? Icon(
                    icon,
                    size: 16,
                    color: onTap == null ? AppColors.textSecondary.withValues(alpha: 0.4) : AppColors.textSecondary,
                  )
                : Text(
                    label!,
                    style: TextStyle(
